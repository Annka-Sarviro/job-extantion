      ...
      <div className="relative">
        <div className={"relative flex w-full items-center"}>
          <input
            id={`input-${name}`}
            className={cn(
              "peer h-11 w-[382px] rounded-xl border px-6 py-[11px] font-nunito text-base font-medium text-text-primary transition placeholder:font-nunito placeholder:text-text-gray placeholder-shown:border-text-primary focus:border-accent focus:outline-none active:border-accent",
              {
          ...
          {error ? (
            ...
            <div
              className={
                "absolute right-2 top-[50%] mt-auto h-6 translate-y-[-50%] cursor-pointer peer-placeholder-shown:hidden bg-white"
              }>
              <svg
                width="24"
                height="24"
        ...
        {error && (
          <span
            id={`inputError-${name}`}
            className="absolute right-0 top-11 inline-block font-nunito text-base font-medium text-error">
